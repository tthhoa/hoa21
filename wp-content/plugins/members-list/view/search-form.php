<div id="members_list_add_item" class="form-modal">
	<form id="members_list_add_item_form" class="WP-ml-modal-form" method="post" action="<?php bloginfo('wpurl'); ?>/wp-admin/admin.php?page=members-list-configure-search">
		<h2><?php _e('Add a new search field','ml'); ?>:</h2>
